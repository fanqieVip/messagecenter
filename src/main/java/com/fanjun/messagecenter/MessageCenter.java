...
public class MessageCenter {
    ...
    private MessageCenter(Context context) {
        ...
        this.centerAdministrator = new MCenterAdministrator(context, messages, messageHanlders);
     ...
     */
    public MessageCenter socketInterceptor(@NonNull SocketInterceptor socketInterceptor) {
    ...
    /**
     * 设置socket自动检查连接状态的间隔时间(默认10秒)
     *
     * @param socketCheckIntervalTime 至少大于10秒
     */
    public MessageCenter setSocketCheckIntervalTime(int socketCheckIntervalTime) {
        this.centerAdministrator.setSocketCheckIntervalTime(socketCheckIntervalTime);
        return this;
    }
     ...
     * @return MessageCenter
     */
    public static MessageCenter create(@NonNull Context context) {
        if (messageCenter == null) {
